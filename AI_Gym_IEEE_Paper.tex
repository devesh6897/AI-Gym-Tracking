...
%     \caption{Confusion Matrix of Exercise Classification Performance}
%     \label{fig:confusion_matrix}
% \end{figure}

% As demonstrated in Figure \ref{fig:confusion_matrix}, the matrix displays the classification accuracy for each exercise type, with darker diagonal elements indicating higher correct classification rates. This visualization helps identify which exercises might be challenging for the model to distinguish. Our system achieves high accuracy in differentiating between push-ups and squats, with minimal confusion between these categories.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{images/class_distribution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/normalization_effect.png}
